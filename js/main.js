...
const skillBaseData = {
    ...
    "Super immortality": {name: "Forbidden technique", maxXp: 1000, effect: 0.04, description: "Longer lifespan"},
...
gameData.requirements = {
    ...
    "Rebirth note 3": new AgeRequirement([document.getElementById("rebirthNote3")], [{requirement: 150}]),
    "Evil info": new EvilRequirement([document.getElementById("evilInfo")], [{requirement: 1}]),
    "Time warping info": new TaskRequirement([document.getElementById("timeWarping")], [{task: "Mage", requirement: 1}]),
    "Automation": new AgeRequirement([document.getElementById("automation")], [{requirement: 2}]),
    "Quick task display": new AgeRequirement([document.getElementById("quickTaskDisplay")], [{requirement: 2}]),
    ...
    "Miner": new TaskRequirement([getTaskElement("Miner")], [{task: "Strength", requirement: 1}, {task: "Fisherman", requirement: 1}]),
    "Blacksmith": new TaskRequirement([getTaskElement("Blacksmith")], [{task: "Strength", requirement: 3}, {task: "Miner", requirement: 1}]),
    "Merchant": new TaskRequirement([getTaskElement("Merchant")], [{task: "Bargaining", requirement: 5}, {task: "Blacksmith", requirement: 1}]),
    ...
    "Knight": new TaskRequirement([getTaskElement("Knight")], [{task: "Strength", requirement: 1}, {task: "Veteran footman", requirement: 1}]),
    ...
    "Legendary knight": new TaskRequirement([getTaskElement("Legendary knight")], [{task: "Mana control", requirement: 10}, {task: "Battle tactics", requirement: 10}, {task: "Holy knight", requirement: 10}]),

    //The Arcane Association
    "Student": new TaskRequirement([getTaskElement("Student")], [{task: "Concentration", requirement: 2}, {task: "Meditation", requirement: 2}]),
    "Apprentice mage": new TaskRequirement([getTaskElement("Apprentice mage")], [{task: "Mana control", requirement: 4}, {task: "Student", requirement: 1}]),
    "Mage": new TaskRequirement([getTaskElement("Mage")], [{task: "Mana control", requirement: 7}, {task: "Apprentice mage", requirement: 1}]),
    "Wizard": new TaskRequirement([getTaskElement("Wizard")], [{task: "Mana control", requirement: 10}, {task: "Mage", requirement: 1}]),
    ...
    "Bargaining": new TaskRequirement([getTaskElement("Bargaining")], [{task: "Concentration", requirement: 2}]),
    "Meditation": new TaskRequirement([getTaskElement("Meditation")], [{task: "Concentration", requirement: 3}, {task: "Productivity", requirement: 2}]),
